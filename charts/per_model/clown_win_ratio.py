...
# New scores for "Clown Win Ratio"
survival_rate_strings = [ # Variable name kept for consistency with original structure, though it now holds win ratios
    "12.5%", "0.0%", "20%", "0.0%", "0.0%", "28.6%", "41.7%", "16.7%",
    "0.0%", "12.5%", "100.0%", "0.0%", "18.2%", "57.1%", "14.3%", "20.0%"
]
...
ax.set_xticks([])
ax.set_title("Clown Win Ratio", fontsize=18, pad=20) # New title

...
for i, bar in enumerate(bars):
    ...
    # Specific modification for "Gemini-2.5 Pro Preview" - this can be removed or adapted if not needed for new data
...
ax.set_xticks([])
ax.set_title("Vampire Points per game", fontsize=18, pad=20) # You might want to change this title
